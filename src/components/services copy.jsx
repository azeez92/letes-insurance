...
var servicesData = [
    {
        id: 1,
        icon: "fas fa-heartbeat", // Health Insurance
    ...
    {
        id: 2,
        icon: "fas fa-user-shield", // Life Insurance
    ...
    {
        id: 3,
        icon: "fas fa-home", // Property Insurance
    ...
    {
        id: 4,
        icon: "fas fa-car", // Auto Insurance
    ...
    {
        id: 5,
        icon: "fas fa-briefcase", // Business Insurance
    ...
    {
        id: 6,
        icon: "fas fa-plane", // Travel Insurance
    ...
    {
        id: 7,
        icon: "fas fa-hand-holding-usd", // Disability Insurance
    ...
    {
        id: 8,
        icon: "fas fa-calendar-alt", // Retirement Planning
